...
async function startApplicationServer() {
    ...
    app.get('/api/pointOfInterests/:id', async (req, res) => {
    ...
    //point of interest.
    app.get('/api/pointOfInterests/itinerariesInvolved/:id', async (req, res) => {
        const id = +req.params.id
    ...
    //point of interest.
    app.get('/api/pointOfInterests/eventsInvolved/:id', async (req, res) => {
        const id = +req.params.id
    ...
    app.post("/api/findInterests", async (req, res) => {
    ...
    //event.
    app.get('/api/events/pointOfInterestsInvolved/:id', async (req, res) => {
        const id = +req.params.id
    ...
    //We pass this specific id in the body of the request, so we use a POST method for implement this API.
    app.post("/api/findEvents", async (req, res) => {
        const id = req.body.id;
        const eventsList = await models.Event.findAll({
            where: {
              typeEventId: id
    ...
    app.post("/api/findEventsByDate", async (req, res) => {
    ...
    //API that returns all the points of interest that host a particular event. It takes from the params the id of the specific
    //event.
    app.get('/api/itineraries/pointOfInterestsInvolved/:id', async (req, res) => {
        const id = +req.params.id
    ...
    //We pass this specific id in the body of the request, so we use a POST method for implement this API.
    app.post("/api/findItineraries", async (req, res) => {
        const id = req.body.id;
    ...
    app.get("/api/servicesType", async (req, res) => {
    ...
    //the user has deciced to see in details.
    app.get('/api/servicesType/:id', async (req, res) => {
        const id = +req.params.id
    ...
    app.get("/api/pointOfInterestsType", async (req, res) => {
    ...
    app.get("/api/itinerariesType", async (req, res) => {
    ...
    app.get("/api/eventsType", async (req, res) => {
